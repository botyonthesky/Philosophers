...
/*   Updated: 2024/03/29 16:44:47 by tmaillar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    if (check_bool(&philo->table->meal_mutex, &philo->table->someone_died) == true)
        return ;
    if (check_bool(&philo->philo_mutex, &philo->is_full) == true)
        return ;
